...
// *****************************************************************************
/* FILTER State data type

  Description:
    This structure will host parameters related to the filter state.
*/
typedef struct
{
    int16_t y1;
...
/* FILTER Input data type
  ...
  Summary:
    FILTER input type define

  Description:
    This structure will host parameters related to the FILTER input. FILTER
    state is a part of the FILTER input.
*/
typedef struct
{
    // PI state as input parameter to the PI controller
    MC_FILTER_STATE_T fstate;
    // Input reference to the PI controller
    int16_t inReference;
    // Input measured value
    int16_t inMeasure;
...
typedef struct
{
    int16_t out;        // Output of the filter
} MC_FILTER_PARAMOUT_T;
...
uint16_t MC_ATTRB MC_FilterUpdate_Assembly(int16_t inReference,
                                                 int16_t inMeasure,
                                                 MC_FILTER_STATE_T *pfilter_state,
                                                 int16_t *pfilter_out);
