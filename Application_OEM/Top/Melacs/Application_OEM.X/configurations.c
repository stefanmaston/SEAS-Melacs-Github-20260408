...
#pragma config FPLLODIV = DIV_1, FSOSCEN = OFF, FPLLMUL = MUL_18, FPLLIDIV = DIV_2, FWDTEN = OFF, FPBDIV = DIV_2, POSCMOD = XT, FNOSC = PRIPLL, CP = OFF
#ifdef _USB_
...
#pragma config FPLLODIV = DIV_1, FSOSCEN = OFF, FPLLMUL = MUL_18, FPLLIDIV = DIV_4, FWDTEN = OFF, FPBDIV = DIV_2, POSCMOD = HS, FNOSC = PRIPLL, CP = OFF
#ifdef _USB_
#pragma config FUSBIDIO = OFF, FVBUSONIO = OFF   // external PHY in RMII/alternate configuration
